<%-- 
    Document   : viewAlbumDetailUser
    Created on : Oct 31, 2024, 7:12:48 PM
    Author     : pheva
--%>
            ...
            <div class="stg-container">
                    ...
                    <div class="stg-row">
                        <div class="stg-col-6 stg-offset-3">
                            <div class="align-center">
                                <h1 class="bringer-page-title" data-appear="fade-up" data-unload="fade-up">Bài hát trong Album ${viewAlbumDetailUser.albumName}</h1>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div class="bringer-grid-3cols bringer-tp-grid-2cols bringer-tp-centered-last-item stg-normal-gap bringer-parallax-media" data-stagger-appear="fade-up" data-threshold="0.5" data-stagger-delay="150" data-stagger-unload="fade-up">
                        <c:forEach var="song" items="${viewAlbumDetailUser.listSong}">
